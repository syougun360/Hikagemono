...
//			spriteStudioData = SpriteStudioDataReferenced.DataGetNode(ID);
	...
	*/
							...
							)
	{
        ...
        Label = (true == string.IsNullOrEmpty(LabelStart) ? NameLabelStart : LabelStart);
#else
...
#if UNITY_METRO_8_1 && !UNITY_EDITOR
        Label = (true == string.IsNullOrEmpty(LabelEnd) ? NameLabelEnd : LabelEnd);
#else
